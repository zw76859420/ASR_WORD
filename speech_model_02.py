...
from keras.layers import Input , Dense , Conv2D , MaxPooling2D , LSTM , GRU
from keras.layers import Reshape , Lambda , Activation , Flatten
from keras.layers import Dropout , regularizers , BatchNormalization
...
class ModelSpeech():
    ...
    def test_model(self , datapath='' , str_dataset='dev' , data_count=1):
        ...
        try:
            ...
            for i in range(data_count):
                ...
                pre = self.predict(data_input=data_input , input_len=data_input.shape[0])                               #卷积修改；
    ...
    def redognize_speech(self , wavsignal , fs):
        ...
        input_length = input_length                                                        #卷积修改;
...
if __name__ == '__main__':
    ...
    datapath = '/home/zhangwei/PycharmProjects/ASR_MFCC/'
